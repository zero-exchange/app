...
import { useWeb3, Web3Provider } from '../../Chainbridge/Web3Context'
...
import AboutDrawer from '../../Chainbridge/Modules/AboutDrawer'
import AddressInput from '../../Chainbridge/Components/Custom/AddressInput'
import ChangeNetworkDrawer from '../../Chainbridge/Modules/ChangeNetworkDrawer'
import FeesFormikWrapped from '../../Chainbridge/Components/Pages/FormikContextElements/Fees'
import NetworkUnsupportedModal from '../../Chainbridge/Modules/NetworkUnsupportedModal'
import PreflightModalTransfer from '../../Chainbridge/Modules/PreflightModalTransfer'
import TransferActiveModal from '../../Chainbridge/Modules/TransferActiveModal'
import clsx from 'clsx'
import { useChainbridge } from '../../Chainbridge/Contexts/ChainbridgeContext'
import TokenSelectInput from '../../Chainbridge/Components/Custom/TokenSelectInput'
import TokenInput from '../../Chainbridge/Components/Custom/TokenInput'
...
export default function CrossChain() {
  ...
  const tokensToWatch = chainbridgeConfig.chains.reduce((tca, bc) => {
    return {
      ...tca,
  ...
  const TransferContent = () =>{const classes = useStyles()
      ...
      <AppBody>
        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={'md'}>
            ...
            {showWrap ? null : <Card padding={'.25rem .75rem 0 .75rem'} borderRadius={'20px'} />}
          </AutoColumn>
          <BottomGrouping>
            {typedValue.length > 0 ? (
              <>
